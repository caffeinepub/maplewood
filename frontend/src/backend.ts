...
import type { GameJob as _GameJob, Home as _Home, PlayerId as _PlayerId, PlayerProfile as _PlayerProfile, Relationship as _Relationship, Settings as _Settings, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getSettings(): Promise<Settings> {
        if (this.processError) {
            try {
                ...
                return from_candid_Settings_n30(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateSettings(arg0: Settings): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSettings(to_candid_Settings_n39(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Settings_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Settings): Settings {
...
function from_candid_record_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        graphicsQuality: from_candid_variant_n32(_uploadFile, _downloadFile, value.graphicsQuality),
        cameraMode: from_candid_variant_n33(_uploadFile, _downloadFile, value.cameraMode),
...
function to_candid_Relationship_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Relationship): _Relationship {
...
function to_candid_record_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        relationships: to_candid_vec_n36(_uploadFile, _downloadFile, value.relationships),
...
function to_candid_record_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        violenceToggle: value.violenceToggle,
        chatEnabled: value.chatEnabled,
        graphicsQuality: to_candid_variant_n41(_uploadFile, _downloadFile, value.graphicsQuality),
        cameraMode: to_candid_variant_n42(_uploadFile, _downloadFile, value.cameraMode),
        controlScheme: value.controlScheme
    };
}
...
function to_candid_variant_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_low_high_medium): {
    low: null;
} | {
    high: null;
} | {
...
function to_candid_variant_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_firstPerson_thirdPerson): {
    firstPerson: null;
} | {
    thirdPerson: null;
} {
...
function to_candid_vec_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Relationship>): Array<_Relationship> {
    return value.map((x)=>to_candid_Relationship_n37(_uploadFile, _downloadFile, x));
}
