...
import { Search, User, Settings, LogOut, LogIn, Users, Bell } from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
            ...
            {isAuthenticated ? (
              <DropdownMenu>
                  ...
                  <Button variant="ghost" className="flex items-center gap-2 px-2">
                    <Avatar className="w-8 h-8 border border-neon-orange/40">
                      <AvatarFallback className="bg-muted text-neon-orange text-xs font-gaming">
                        {displayName ? displayName.slice(0, 2).toUpperCase() : 'PL'}
                      </AvatarFallback>
                    </Avatar>
                    {displayName && (
                ...
                <DropdownMenuContent align="end" className="panel-dark border-border w-48">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={handleAuth} className="cursor-pointer text-neon-red">
