...
const SYSTEM_MESSAGES: ChatMessage[] = [
  { id: '1', sender: 'SYSTEM', text: 'Welcome to Maplewood, Canada! Explore the city, mountains, and forests.', timestamp: new Date(), type: 'system' },
  { id: '2', sender: 'SYSTEM', text: 'Press E to interact with objects and NPCs. Press V to toggle camera.', timestamp: new Date(), type: 'system' },
];
      ...
      {isOpen ? (
        <div className="panel-glass rounded-lg w-72 border border-neon-orange/20 animate-slide-in">
          <div className="flex items-center justify-between px-3 py-2 border-b border-border">
            <span className="font-gaming text-xs text-neon-orange tracking-wider">CHAT</span>
          ...
          <ScrollArea className="h-40 px-3 py-2 scrollbar-gaming" ref={scrollRef as React.RefObject<HTMLDivElement>}>
              ...
              {messages.map((msg) => (
                <div key={msg.id} className="text-xs">
                  {msg.type === 'system' ? (
                    ...
                    <>
                      <span className="text-neon-orange font-medium">{msg.sender}: </span>
          ...
          <div className="flex gap-1 p-2 border-t border-border">
            ...
            />
            <Button size="icon" onClick={handleSend} className="h-7 w-7 btn-neon">
