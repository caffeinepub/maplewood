...
function VehicleMesh({
  vehicle,
  onEnter,
}: { vehicle: VehicleData; onEnter: () => void }) {
    ...
    >
      ...
      {(vehicle.type === "car" || vehicle.type === "truck") &&
        [
          ...
          <mesh
            // biome-ignore lint/suspicious/noArrayIndexKey: static fixed-length wheel array
            key={i}
            position={wp as [number, number, number]}
